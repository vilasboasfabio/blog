function entrar() {
    ...
    var text2 = window.document.querySelector('p#text')
    var title1 = window.document.querySelector('h3#hobtit')
...
function sair() {
    ...
    aument1.style.width = '40%'
    text2.style.fontSize = '15px'
    title1.style.fontSize = '22px'
}

function sair1() {
    var aument1 = window.document.querySelector('section#hob1')
    var aument2 = window.document.querySelector('section#hob2')
    var text4 = window.document.querySelector('p#text1')
    var title2 = window.document.querySelector('h3#hobtit1')
    ...
    aument2.style.width = '40%'
    text4.style.fontSize = '15px'
    title2.style.fontSize = '22px'
}
...
function clickent() {
    ...
    aument3.style.width = '60%'
    aument3.style.border = '5px solid white'
    tit1.style.fontSize = '36px'
    text5.style.fontSize = '22px'
}
...
function clickexit() {
    ...
    aument3.style.width = '40%'
    aument3.style.border = '0px solid white'
    tit1.style.fontSize = '24px'
